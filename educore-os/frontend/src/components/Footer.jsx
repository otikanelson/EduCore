        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/contact-sales" className="text-sm text-gray-600 hover:text-gray-900">Request Demo</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:support@educore.ng" className="text-sm text-gray-600 hover:text-gray-900">Support</a></li>
            </ul>
          </div>
